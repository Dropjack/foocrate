...
- FooCrate Preferences 提供默认开启的 `Restore Playlist View to last played track`。它只恢复 Playlist View 的列表、专辑组、曲目焦点与滚动位置；实际播放启动和时间点恢复继续服从 foobar2000 核心，不由 FooCrate 建立第二套播放会话。
